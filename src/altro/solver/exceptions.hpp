...
#define ALTRO_THROW(msg, code) \
  ...
  (Serial.print("ALTRO ERROR Code "); Serial.print(static_cast<int>(code)); Serial.print(": "); Serial.print(ErrorCodeToString(code)); Serial.print(" "); Serial.print(__FILE__); Serial.print(":"); Serial.print(__LINE__); Serial.print("\n  Message: "); Serial.println(msg);)
#endif
